...
<table width="650" height="561"  border="0" align="center" cellpadding="5" cellspacing="5" >
  ...
  <tr>
    <td width="650" height="126" valign=top>
        <form action="adminachievement.php" method="post" name="feedback_form" onsubmit="return chkForm();">
	...
	<tr>
          ...
          <td><label>
            <?php
			 $sel_fac="select distinct roll_no from achievement_master";
		...
		<tr>
		  ...
		  <?php
		  $roll = $_POST['stu_id'];	
                  $sql_que="select * from achievement_master where roll_no='".$roll."'";
			...
			while($row_que=mysql_fetch_array($res_que))
			{
				...
				//echo "<td> <input type=\"text\" name=\"ans_$i\" size=\"3\" onkeypress=\"return isNumberOnly(event);\" maxlength=\"2\" tabindex=\"$tab_ind\" /></td>";$tab_ind++;
                                ...
                                echo "<td>".$row_que['achievement_name']."</td>";echo "</tr>";$i++;
