...
<table width="650" height="561"  border="0" align="center" cellpadding="5" cellspacing="5" >
  ...
  <tr>
    <td width="650" height="126" valign=top>
        <form action="adminpage.php" method="post" name="feedback_form" onsubmit="return chkForm();">
      <table width="711" border="0" align="center">        
		...
		<tr>
          <td colspan="5" align="center">Average Rating from 0 to 9 given by students.</td>
        </tr>
		<tr>
          <td colspan="5">
