...
<table width="650" height=""  border="0" align="center" cellpadding="5" cellspacing="5" >
  ...
  <tr>
    <td width="650"  valign="bottom" align="center"><p><b><font size="5" >Student Complaint form</font></b></p></td>
  </tr>
  <tr>
    <td width="650" height="126" valign=top>
	<form action="submit_complain.php" method="post" name="feedback_form" onsubmit="return chkForm();">
